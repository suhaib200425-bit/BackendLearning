...
function BannerDisplay({ setPAGE, PAGE, setImageUrl, setBanner, setUPDATE,type }) {
    ...
    const deletebanner = async (bannerId) => {
        ...
        res.data.status && setAllBanner(AllBanner.filter(item => item.id !== bannerId))
        ...
        <div className='BannerDisplay col-12 row'>
            ...
            </div>
            {
                AllBanner && AllBanner.map(elem => (
                    <div className={type!='banner'?"col-3 Image_Box":"col-6 Image_Box"} key={elem.id}>
                        ...
                        <div className={type!='banner'?"TopBar col-12 flex-column":"TopBar col-12"}>
                            ...
                            <div className="d-flex gap-2">
                                ...
                                <button className='Botton_New_item' onClick={() => deletebanner(elem.id)} >Remove</button>
                            </div>
                        </div>
                    </div>
                ))
